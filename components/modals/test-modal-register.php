<div class="modal-content">
    ...
    <form id="registerForm" type="POST" onSubmit="registerHandler(event)" name="modalForm">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="RU_firstName" name="first_name" placeholder="Enter First Name" autocomplete require maxlength="50">
        </div>
        <div class="form-group mt-4">
            <input type="text" class="form-control" id="RU_lastName" name="last_name" placeholder="Enter Last Name"  autocomplete require maxlength="50">
            </div>
            <div class="form-group mt-4">
